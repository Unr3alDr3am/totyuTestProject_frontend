...
<!-- 头部导航 -->
      <el-header class="home-header">
        <span class="home_title">rainbow</span> <span class="home_title">东忠课程管理系统</span>
        ...
        <span class="el-dropdown-link home_userinfo" style="display: flex;align-items: center; color:#20a0ff ">
          {{user.nickname}}
          <i><img v-if="user.headimgurl != ''" :src="user.headimgurl"  style="width: 40px;height: 40px;margin-right: 5px;margin-left: 5px;border-radius: 40px"/>
              <img v-if="user.headimgurl == ''" src="@/assets/back.jpg"  style="width: 40px;height: 40px;margin-right: 5px;margin-left: 5px;border-radius: 40px"/>
          </i>
        </span>    
